...
class Main extends React.Component {
    ...
    recordsUrl = this.apiUrl.concat(`/v2/records`)
    dailyExpenseReportUrl = this.apiUrl.concat(`/v2/telegram/daily`)
            ...
            return (<div>
                <div className="action-holder" >
                    <div id="add-btn"
                        ...
                        Add Record </div> <div id="send-daily-report-btn"
                            className="actions"
                            onClick={
                                () => this.sendDailyReport()} >
                        Send Daily Report </div> <div id="send-analytics"
                            className="actions" >
                        Send Analytics </div> </div> <div>
